...
def build_social_world_e2e_app(db_path: str | Path | None = None):
    path = Path(db_path or os.environ.get("SAM_SEBE_DB", "data/e2e-social-world.sqlite3"))
...
def main() -> None:
    uvicorn.run(build_social_world_e2e_app(), host="127.0.0.1", port=8000)
