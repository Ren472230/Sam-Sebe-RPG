...
export class DialoguePanel {
  ...
  private renderDecision(decision: DialogueDecision): void {
    ...
    if (snapshot.quest.status === "available" && decision.proposal === "offer_quest:bring_5_firewood") {
    ...
    this.showMessage("Орен", decision.text, actions, decision.used_fallback ? "локальная реплика" : "AI-реплика");
  }
